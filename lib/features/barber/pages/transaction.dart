import 'package:barber_app/core/models/transaction_model.dart';
import 'package:barber_app/features/barber/widgets/transaction_card.dart';
import 'package:barber_app/features/barber/widgets/transaction_filter_bar.dart';
...
class _TransactionPageState extends State<TransactionPage>
  ...
  void _onAccept(String id) {
    ...
    _showConfirmDialog(
      ...
      message:
          'Booking ini akan dikonfirmasi dan customer akan mendapat notifikasi.',
      confirmLabel: 'Terima',
      confirmColor: _gold,
  ...
  void _onReject(String id) {
    ...
    _showConfirmDialog(
      ...
      title: 'Tolak Booking?',
      message:
          'Booking ini akan ditolak dan customer akan mendapat notifikasi.',
      confirmLabel: 'Tolak',
