...
// ═══════════════════════════════════════════════════════════════════════════════
// MODEL LOKAL (inline, tidak import dari luar)
// ═══════════════════════════════════════════════════════════════════════════════
  ...
  List<_BookingHistory> get _filtered {
    switch (_activeFilter) {
      ...
      case _HistoryFilter.selesai:
        return _kDummyData
            .where((h) => h.status == _HistoryStatus.selesai)
            .toList();
      case _HistoryFilter.ditolak:
        return _kDummyData
            .where((h) => h.status == _HistoryStatus.ditolak)
            .toList();
    }
  }
          ...
          GestureDetector(
            onTap: () {
              ...
              Navigator.push(
                context,
                PageRouteBuilder(
                  pageBuilder: (_, a, b) => const NotificationScreen(),
  ...
  Widget _buildEmptyState() {
    return Center(
      child: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          const Icon(Icons.history_rounded, color: Color(0xFF3A3A3C), size: 56),
      ...
      child: IntrinsicHeight(
        child: Row(
          children: [
            ...
            Expanded(
              child: Padding(
                padding: EdgeInsets.fromLTRB(_isSelesai ? 14 : 18, 16, 16, 16),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
      ...
      return Container(
        ...
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            ...
            colors: isSelesai
                ? [_gold.withOpacity(0.8), _gold.withOpacity(0.4)]
                : [const Color(0xFF3A3A3C), const Color(0xFF2C2C2E)],
          ),
          border: Border.all(
            color: isSelesai ? _gold.withOpacity(0.3) : const Color(0xFF3A3A3C),
            width: 1.5,
          ),
        ),
        alignment: Alignment.center,
...
class _StatusBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isSelesai ? const Color(0xFF2C2C2E) : const Color(0xFF2A0A0A),
        borderRadius: BorderRadius.circular(8),
        border: Border.all(
          color: isSelesai ? const Color(0xFF3A3A3C) : const Color(0xFF5A1A1A),
          width: 1,
        ),
      ),
      child: Text(
        ...
        style: TextStyle(
          color: isSelesai ? const Color(0xFF8E8E93) : const Color(0xFFFF453A),
          fontSize: 10,
          fontWeight: FontWeight.w700,
          letterSpacing: 0.5,
        ),
